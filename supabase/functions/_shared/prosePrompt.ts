...
export function buildSystemPrompt(A: string, B: string, language: string): string {
  ...
  return [
    ...
    "DIGIT RULE: write EVERY number using Latin digits 0-9 only, even in Hindi prose. Never use Devanagari digits (०१२३४५६७८९) and never spell a core number out in words.",
